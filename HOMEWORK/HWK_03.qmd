...
The code is adding 3, which is a vector that only has one number, to the first vector that had multiple numbers. This means that each number in the first vector is getting 3 added to it. 
